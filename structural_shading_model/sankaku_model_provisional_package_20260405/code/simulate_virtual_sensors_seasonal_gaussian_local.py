...
def direct_open_at_points(base, x, y, z, sx, sy, sz, house, geom):
    ray_len = 100.0
    return visibility_from_source_to_points(base, x, y, z, x + sx * ray_len, y + sy * ray_len, z + sz * ray_len, house, geom)
...
def run(output_dir="output_virtual_sensors_gaussian_local"):
